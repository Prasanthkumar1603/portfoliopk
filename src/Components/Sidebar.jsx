...
const Header = () => {
  ...
  return (
    <header className="bg-animated-gradient text-white fixed w-full top-0 left-0 h-16 flex items-center justify-between px-4 md:px-8 z-50">
      <h1 className="text-lg md:text-xl font-bold">PK Portfolio</h1>
      ...
      {/* Navigation */}
      <nav
        className={`${isOpen ? 'block' : 'hidden'} absolute top-16 left-0 w-full bg-animated-gradient md:static md:flex md:items-center md:space-x-8 md:w-auto`}
      >
        <ul className="flex flex-col items-center space-y-4 md:flex-row md:space-x-8 md:space-y-0 py-4 md:py-0">
          ...
          <li><a href="#certificate" className="hover:text-gray-300">Certifications</a></li>
